...
Body
    Logo.sticky
    Header.sticky
    div.font-mono.text-charcoal.space-y-4.border-slate-gray.size-fit
        ...
        h2.text-xl.p-4.mb-16 Links to Popular Practice Management Websites
        div.font-bold.grid.grid-cols-3.gap-4.flex.rounded-sm.border-slate-gray.mb-16
